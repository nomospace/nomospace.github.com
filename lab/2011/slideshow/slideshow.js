...
(function(){
	// 添加事件接口
   	var addEvent = !!document.addEventListener ? 
		function(_element, _type, _handler, _capture){_element.addEventListener(_type, _handler, !!_capture);}: 
		function(_element, _type, _handler){_element.attachEvent('on' + _type, _handler);}
	// 绑定接口及参数，使其的调用对象保持一致
    ...
    SimpleSlideShowModule.prototype = {
		...
		_$initialize: function(){
			for (var i = 0, l = this.__rightItems.length, _item; i < l; i++) {
