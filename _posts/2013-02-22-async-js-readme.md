...
Async 提供了近 20 个函数方法，包括常见的函数式
suspects，比如 map，reduce，filter，each 等，以及一些异步控制流模式，比如 parallel， series，waterfall 等。所有这些函数让使用者遵循 node.js 约定，将异步函数的最后一个参数指定一个简单的回调函数。
